...
public class Functions extends atmMachine{
    ...
    final void updateUsrDet(){
        ...
        usr1.put("UserName", "Rathish");
        usr1.put("Pin", "9999");
        usr1.put("BankName", "Reserve");
        usr1.put("Balance", "1000000");
        usr1.put("transCnt", "0");
        usr1.put("Statement", "");

        usrDet.add(usr1);

        usr2.put("UserName", "Pranav");
        usr2.put("Pin", "9852");
        usr2.put("BankName", "Reserve");
        usr2.put("Balance", "1000000");
        usr2.put("transCnt", "0");
        usr2.put("Statement", "");
